...
BUILTIN_PRESETS: dict[str, dict] = {
    ...
    "TikTok / Reels / Shorts (9:16 单语中文)": _config_with(**{
        "aspect": "9:16",
        "subtitle.sub1.enabled": True,
        "subtitle.sub1.fontsize": 28,
        "subtitle.sub1.bold": True,
        "subtitle.sub1.is_chinese": True,
        "subtitle.sub2.enabled": False,
        "subtitle.position": "bottom",
    }),
    "TikTok / Reels / Shorts (9:16 双语)": _config_with(**{
        "aspect": "9:16",
        "subtitle.sub1.enabled": True,
        "subtitle.sub1.fontsize": 26,
        "subtitle.sub1.bold": True,
        "subtitle.sub1.is_chinese": True,
        "subtitle.sub2.enabled": True,
        "subtitle.sub2.fontsize": 22,
        "subtitle.sub2.bold": False,
        "subtitle.sub2.is_chinese": False,
        "subtitle.position": "bottom",
    }),
    "YouTube 横屏 (16:9 单语中文)": _config_with(**{
        "aspect": "16:9",
        "subtitle.sub1.enabled": True,
        "subtitle.sub1.fontsize": 30,
        "subtitle.sub1.bold": True,
        "subtitle.sub1.is_chinese": True,
        "subtitle.sub2.enabled": False,
        "subtitle.position": "bottom",
    ...
    "B站横屏 (16:9 双语)": _config_with(**{
        ...
        "subtitle.sub1.is_chinese": True,
        "subtitle.sub2.enabled": True,
        "subtitle.sub2.fontsize": 24,
        "subtitle.sub2.bold": False,
        "subtitle.sub2.is_chinese": False,
        "subtitle.position": "bottom",
    }),
    "Instagram / 小红书 (1:1 中文)": _config_with(**{
        "aspect": "1:1",
        "subtitle.sub1.enabled": True,
        "subtitle.sub1.fontsize": 26,
        "subtitle.sub1.bold": True,
