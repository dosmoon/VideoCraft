...
code (see docs/draft/electron-migration-design.md §2-3). The Electron main
process spawns this as a child and talks to it over stdio; the renderer is a
thin client that issues `ipc.call(method, params)` requests.
