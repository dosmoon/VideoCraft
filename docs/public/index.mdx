...
![VideoCraft main window — project hub with the material tree on the left and inline source preview on the right](./screenshot-hub-en.png)

*The project hub: one source video per project, subtitles and chapters as materials, creations derived from them.*
