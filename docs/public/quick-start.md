...
![Material tree: source video, news context, bilingual subtitles, chapters and hotclips](./screenshot-material-tree-en.png)

*The material tree of a project — one source video, bilingual subtitles, chapters and hotclips.*

![Clip workbench with hotclip candidates on the left and a styled preview on the right](./screenshot-clip-workbench-en.png)

*Clip workbench — pick hotclip candidates on the left, preview the styled short video on the right.*

![News Desk workbench with bilingual subtitles, name plate and chapter strip in the live preview](./screenshot-news-desk-style-en.png)

*News Desk workbench — bilingual subtitles, lower-third name plate and chapter strip, styled live in the preview.*

![Render and export panel with engine, resolution, fps and bitrate options](./screenshot-render-export-en.png)
...
![Model Manager listing the embedded AI runtime, GPU acceleration and local ASR / LLM models](./screenshot-model-manager-en.png)
