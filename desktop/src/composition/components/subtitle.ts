...
export const subtitleFields: readonly FieldSpec[] = [
  ...
  { key: "block_margin_pct", control: "number", labelKey: "subtitle.block_margin", min: 0, max: 0.4, display: { factor: 100, step: 1, suffix: "%" } },
  { key: "fontsize_pct", control: "number", labelKey: "subtitle.fontsize", min: 0, max: 0.5, display: { factor: 1080, step: 1, suffix: "px" } },
  ...
  { key: "stroke_pct", control: "number", labelKey: "subtitle.stroke_width", min: 0, max: 0.02, display: { factor: 1080, step: 1, suffix: "px" } },
  { key: "bg_enabled", control: "checkbox", labelKey: "subtitle.bg_enabled" },
  { key: "bg_color", control: "color", labelKey: "subtitle.bg_color" },
  { key: "bg_opacity", control: "number", labelKey: "subtitle.bg_opacity", min: 0, max: 100, display: { factor: 1, step: 1, suffix: "%" } },
  { key: "bg_padding_x_pct", control: "number", labelKey: "subtitle.bg_padding_x", min: 0, max: 0.2, display: { factor: 100, step: 1, suffix: "%" } },
];
